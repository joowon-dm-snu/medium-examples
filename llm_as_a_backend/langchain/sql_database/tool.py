# https://github.com/hwchase17/langchain/blob/master/langchain/tools/sql_database/tool.py
...
LLMChain = ClassVar("LLMChain")
# from langchain.llms.openai import OpenAI
OpenAI = ClassVar("OpenAI")
# from langchain.prompts import PromptTemplate
PromptTemplate = ClassVar("PromptTemplate")
# from langchain.sql_database import SQLDatabase
SQLDatabase = ClassVar("SQLDatabase")
# from langchain.tools.base import BaseTool
BaseTool = ClassVar("BaseTool")
# from langchain.tools.sql_database.prompt import QUERY_CHECKER
QUERY_CHECKER = ClassVar("QUERY_CHECKER")
