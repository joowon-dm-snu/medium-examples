...
CRITIQUE_PROMPT = """Below is conservation between a human and an AI model.
Human: {input_prompt}
...
# langchain/chains/constitutional_ai/prompts.py
REVISION_PROMPT = """Below is conservation between a human and an AI model.
Human: {input_prompt}
Model: {output_from_model}
...
# CRITIQUE_PROMPT, REVISION_PROMPT 를 위한 예시의 모음입니다.
examples = [
    {
